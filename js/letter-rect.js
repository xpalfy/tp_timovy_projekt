        ...
        this.shadowRoot.innerHTML = `
            ...
            >
                <polygon points="${x1},${y1} ${x2},${y2} ${x3},${y3} ${x4},${y4}" 
                         style="fill:#007bff1c;stroke:black;stroke-width:1; pointer-events: auto;" />
                <circle cx="${x1}" cy="${y1}" r="3" fill="#007bff" style="pointer-events: auto;" />
                <circle cx="${x2}" cy="${y2}" r="3" fill="#007bff" style="pointer-events: auto;" />
                <circle cx="${x3}" cy="${y3}" r="3" fill="#007bff" style="pointer-events: auto;" />
                <circle cx="${x4}" cy="${y4}" r="3" fill="#007bff" style="pointer-events: auto;" />
            </svg>
        `;
    }
}
