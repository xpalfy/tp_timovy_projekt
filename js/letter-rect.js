    ...
    render() {
        ...
        this.shadowRoot.innerHTML = `
            <svg width="100%" height="100%">
                <polygon points="${x1},${y1} ${x2},${y2} ${x3},${y3} ${x4},${y4}" style="fill:#007bff1c;stroke:black;stroke-width:1" />
                <circle cx="${x1}" cy="${y1}" r="2" fill="#007bff" />
                <circle cx="${x2}" cy="${y2}" r="2" fill="#007bff" />
                <circle cx="${x3}" cy="${y3}" r="2" fill="#007bff" />
                <circle cx="${x4}" cy="${y4}" r="2" fill="#007bff" />
            </svg>
        `;
    }
}
