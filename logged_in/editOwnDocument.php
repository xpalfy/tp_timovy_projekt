...
<<<<<<< Updated upstream
                            ...
                            <div class="lg:w-1/6 w-full flex items-center justify-center">
                                <label for="isPublic" class="flex items-center cursor-pointer select-none">
                                    <div class="relative">
                                        ...
                                        <div
                                            class="w-12 h-6 bg-gray-300 rounded-full peer-checked:bg-yellow-400 transition-colors duration-300">
                                        </div>
                                        <div
            ...
            <div class="w-full lg:w-1/2 flex">
                <div
                    class="bg-yellow-100 bg-opacity-70 rounded-xl p-6 shadow-lg w-full min-h-[450px] flex flex-col justify-between">
                    <div>
