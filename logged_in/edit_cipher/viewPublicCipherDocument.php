...
<main class="flex-grow container mx-auto px-4 py-10">
    <h1 id="docTitle" class="text-4xl font-bold text-center mb-10">View Public Cipher Document Here</h1>
    ...
    <div class="flex flex-col lg:flex-row gap-10 items-stretch mt-10">
        ...
        <div class="w-full lg:w-1/2 flex">
            <div class="bg-white bg-opacity-50 rounded-xl p-6 shadow-lg w-full">
                <label for="jsonData" class="block font-semibold mb-6 text-[#3b2f1d]">Cipher JSON</label>
