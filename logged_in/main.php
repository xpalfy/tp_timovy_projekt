                ...
                <li class="flex items-center">
                    <div class="relative flex items-center">
                        ...
                        <div id="dropdownTools"
                             class="z-10 hidden font-normal bg-[#d7c7a5] divide-y divide-gray-100 rounded-lg shadow w-44 absolute top-full mt-2">
                            <ul class="py-2 text-sm text-[#3b2f1d]">
                                <li><a href="./modules/segmentModule.php"
                                       class="block px-4 py-2 hover:bg-[#cbbd99]">Segment</a>
                                </li>
                                <li><a href="./modules/analyzeModule.php"
                                       class="block px-4 py-2 hover:bg-[#cbbd99]">Analyze</a>
                                </li>
                                <li><a href="./modules/lettersModule.php"
                                       class="block px-4 py-2 hover:bg-[#cbbd99]">Letters</a>
                                </li>
                                <li><a href="./modules/editJsonModule.php"
                                       class="block px-4 py-2 hover:bg-[#cbbd99]">Edit
                                        Json</a></li>
                                <li><a href="./modules/decipherModule.php"
...
<div id="warningText"
    ...
    <span class="close" onclick="hideWarning()">&times;</span>
    ...
    <div
        ...
        <div class="hidden duration-700 ease-in-out slide-custom" data-carousel-item>
            ...
            <div class="flex justify-center overflow-hidden max-h-[400px]">
                <img src="../img/main_11.png" alt="Handwriting decryption preview"
    ...
    <div class="glass max-w-4xl mx-auto animate-fade-in-slow border-yellow-300 border">
        ...
        <div
            ...
            <div class="step-progress-container not-copyable not-draggable">
                <a class="step-group" href="#bookmark">
                    <div class="step">1</div>
                    <h3 class="step-info text-papyrus">Upload Image</h3>
                </a>
                <div class="line"></div>
                <a class="step-group" href="modules/segmentModule.php">
                    <div class="step active">2</div>
                    <h3 class="step-info text-papyrus">Segment Page</h3>
                </a>
                <div class="line"></div>
                <a class="step-group" href="modules/analyzeModule.php">
                    <div class="step">3</div>
                    <h3 class="step-info text-papyrus">Segment Sections</h3>
                </a>
                <div class="line"></div>
                <a class="step-group" href="modules/lettersModule.php">
                    <div class="step">4</div>
                    <h3 class="step-info text-papyrus">Segment Letters</h3>
                </a>
                <div class="line"></div>
                <a class="step-group" href="modules/editJsonModule.php">
        ...
        <h3 id="ProcessInfo" class="not-copyable text-2xl mt-4 font-bold text-center text-papyrus mb-6">
            Start your journey by uploading an image of your document.
        </h3>
        <p id="ProcessInfoMini" class="text-center text-gray-600 mb-4 pr-10 pl-10">
            The uploaded image will be analyzed by our AI system wich will recommend the type of your document.
...
<script>
    function hideWarning() {
        ...
        document.cookie = "hideWarning=true; path=/; max-age=31536000"; // valid for 1 year
    }

    function shouldHideWarning() {
        return document.cookie.split(';').some(cookie => cookie.trim().startsWith('hideWarning=true'));
    }
