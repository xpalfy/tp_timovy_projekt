...
<body class="min-h-screen flex flex-col not-copyable not-draggable text-papyrus">
    ...
    <main id="ProcessArea" class="flex-grow container mx-auto px-4 mt-10">
        <div class="glass max-w-4xl mx-auto animate-fade-in-slow border-yellow-300 border"
            ...
            <p id="ProcessInfoMini" class="text-center text-gray-600 mb-4 pr-10 pl-10">
                On this page, you can review and adjust the detected section boundaries of your uploaded document. 
                Move or resize the highlighted areas to match the actual sections, and change their type if needed. 
                When you are satisfied with the segmentation, save your changes to continue processing the document. 
            ...
            <!-- Image Analyzer -->
            <div class="col-md mt-5" id="imageAnalyzer" style="display: none; transition: transform 0.5s ease;">
            ...
            <div id="btns" class="flex justify-center items-center mt-5 mb-5 gap-2"
                ...
                <button id="addRectButton" class="bg-[#d7c7a5] text-papyrus border border-yellow-300 rounded-lg p-2"
                    style="display: none;" onclick="addNewRect('previewContainerAnalyze')">Add Segmentation
                    Zone</button>
    ...
    <script type="module" src="../js/analyzeModule.js?v=<?= time() ?>"></script>
</body>
