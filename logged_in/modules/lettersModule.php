...
<body class="min-h-screen flex flex-col not-copyable not-draggable text-papyrus">
    ...
    <main id="ProcessArea" class="flex-grow container mx-auto px-4 mt-10">
        <div class="glass max-w-4xl mx-auto animate-fade-in-slow border-yellow-300 border"
            ...
            <p id="ProcessInfoMini" class="text-center text-gray-600 mb-4 pr-10 pl-10">
                This tool allows you to detect and segment individual letters, symbols, or words from your uploaded document image. 
                Select a document, then choose a section to work on. You can manually add, move, or adjust polygons to mark each letter or symbol.
            ...
            <!-- Image Letters -->
            <div class="col-md mt-5" id="imageLetter" style="display: none; transition: transform 0.5s ease;">
            ...
            <div id="btns" class="flex justify-center items-center mt-5 mb-5 gap-2"
                ...
                <button id="addRectButton" class="bg-[#d7c7a5] text-papyrus border border-yellow-300 rounded-lg p-2"
                    style="display: none;" onclick="addNewRect('previewContainerLetter','letter-rect')">Add Segmentation
                    Zone</button>
    ...
    <script type="module" src="../js/lettersModule.js?v=<?= time() ?>"></script>
</body>
