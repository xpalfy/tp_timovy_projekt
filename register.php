  ...
  <nav class="bg-[#d7c7a5] shadow sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <div class="hidden md:flex space-x-6 text-lg items-center">
        ...
        <a href="https://tptimovyprojekt.ddns.net/" class="hover:underline">Minutes</a>
    ...
    <div class="glass p-10 w-full max-w-md my-10" data-aos="fade-up">
      ...
      <form id="registerForm" class="space-y-4">
        <div>
          ...
          <input type="text" id="username" name="username" oninput="isValidInput(this)"
            class="w-full p-3 border rounded" required>
        </div>
        <div>
          <label for="email" class="block mb-1 font-medium">Email</label>
          <input type="email" id="email" name="email" oninput="isValidEmail(this)" class="w-full p-3 border rounded"
            required>
        </div>
        <div>
          <label for="password" class="block mb-1 font-medium">Password</label>
          <input type="password" id="password" name="password" oninput="isValidPassword(this)" autocomplete="off"
            class="w-full p-3 border rounded" required>
        </div>
        <div>
          <label for="password_confirm" class="block mb-1 font-medium">Confirm Password</label>
          <input type="password" id="password_confirm" name="password_confirm" oninput="isValidPassword(this)"
            autocomplete="off" class="w-full p-3 border rounded" required>
        </div>
